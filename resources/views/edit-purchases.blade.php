@extends('layouts.app', ['activePage' => 'profile', 'titlePage' => __('Edit Purchases')])
  ...
  <div class="content" >
    <div class="container-fluid">
      <div class="row" style="overflow-y: scroll;height:600px">
        <div class="col-md-12"  >
          <form method="post" action="/edit-purchases/{{ $car->id }}" autocomplete="off" class="form-horizontal">
            @csrf
           @method('put')
            <div class="card ">
                ...
                <div class="row">
                  <div class="col-sm-4">
                    ...
                    <div class="col-sm-12">
                        ...
                        <input class="form-control{{ $errors->has('model') ? ' is-invalid' : '' }}" name="model" id="input-model" type="text" placeholder="model" required="true" aria-required="true" value="{{ old('model') ?? $car->model }}" />
                        @if ($errors->has('model'))
                  ...
                  <div class="col-sm-4">
                    ...
                    <div class="col-sm-12">
                        ...
                        <input class="form-control{{ $errors->has('make') ? ' is-invalid' : '' }}" name="make" id="input-make" type="text" value="{{ old('make') ?? $car->make }}"  placeholder="make" required="true" aria-required="true"/>
                        @if ($errors->has('make'))
                  ...
                  <div class="col-sm-4">
                    ...
                    <div class="col-sm-12">
                        ...
                        <input class="form-control{{ $errors->has('y_o_m') ? ' is-invalid' : '' }}" name="y_o_m" id="input-y_o_m" type="text" placeholder="Year of making" value="{{ old('y_o_m') ?? $car->y_o_m  }}" required="true" aria-required="true"/>
                        @if ($errors->has('y_o_m'))
                ...
                <div class="row">
                  <div class="col-sm-4">
                    ...
                    <div class="col-sm-12">
                        ...
                        <input class="form-control{{ $errors->has('color') ? ' is-invalid' : '' }}" name="color" id="input-color" value="{{ old('color') ?? $car->color }}"  type="text" placeholder="i.e. Yellow ,Black" required="true" aria-required="true"/>
                        @if ($errors->has('color'))
                  ...
                  <div class="col-sm-4">
                    ...
                    <div class="col-sm-12">
                        ...
                        <input class="form-control{{ $errors->has('reg_no') ? ' is-invalid' : '' }}" name="reg_no" id="input-reg_no" type="text" placeholder="i.e. KAB 225Y"   value="{{ old('reg_no') ?? $car->reg_no }}" required="true" aria-required="true"/>
                ...
                <div class="row">
                  ...
                  <div class="col-sm-4">
                    ...
                    <div class="col-sm-12">
                        ...
                        <input class="form-control{{ $errors->has('price') ? ' is-invalid' : '' }}" name="price" id="input-price" type="text" placeholder="{{ __('price') }}" value="{{ old('price') ?? $car->price }}" required="true" aria-required="true"/>
                        @if ($errors->has('price'))
              ...
              <div class="card-body ">
                ...
                <div class="row">
                  <div class="col-sm-4">
                    ...
                    @if( $car->surplier_type == "Individual")

                    <div class="form-group{{ $errors->has('type') ? ' has-danger' : '' }}">
                            <input name="surplier_type" id="selectType" class="form-control"  value="{{ old('surplier_type') ?? $car->surplier_type}}" onchange="myFunction()"/> 
                  ...
                  <div class="col-sm-4" id="first_name">
                    ...
                    <div class="col-sm-12">
                        ...
                        <input class="form-control{{ $errors->has('first_name') ? ' is-invalid' : '' }}" name="first_name" id="input-first_name" type="text" placeholder="First Name" value="{{ old('first_name') ?? $car->first_name }}" />
                  ...
                  <div class="col-sm-4" id="middle_name">
                    ...
                    <div class="col-sm-12">
                        ...
                        <input class="form-control{{ $errors->has('middle_name') ? ' is-invalid' : '' }}" name="middle_name" id="input-middle_name" type="text" placeholder="Middle Name" value="{{ old('middle_name') ?? $car->middle_name}}" />
                  ...
                  <div class="col-sm-4" id="last_name">
                    ...
                    <div class="col-sm-12">
                        ...
                        <input class="form-control{{ $errors->has('last_name') ? ' is-invalid' : '' }}" name="last_name" id="input-last_name" type="text" placeholder="Last Name" value="{{ old('last_name') ?? $car->last_name }}" />
                    ...
                    @elseif($car->surplier_type == "Company")
                  ...
                  <div class="col-sm-4" id="com_name">
                    ...
                    <div class="col-sm-12">
                        ...
                        <input class="form-control{{ $errors->has('company_name') ? ' is-invalid' : '' }}" name="company_name" id="input-company_name" type="text" value="{{ old('company_name') ?? $car->company_name }}"  placeholder="company_name">
                  ...
                  <div class="col-sm-4">
                    ...
                    <div class="col-sm-12">
                        ...
                        <input class="form-control{{ $errors->has('city') ? ' is-invalid' : '' }}" name="city" id="input-city" type="text" placeholder="City" value="{{ old('city') ?? $car->city }}" />
                        @if ($errors->has('city'))
                  ...
                  <div class="col-sm-4">
                    ...
                    <div class="col-sm-12">
                        ...
                        <input class="form-control{{ $errors->has('phone_number') ? ' is-invalid' : '' }}" name="phone_number" id="input-phone_number" type="text" placeholder="Phone number" value="{{ old('phone_number') ?? $car->phone_number }}"  />
                  ...
                  <div class="col-sm-4">
                    ...
                    <div class="col-sm-12">
                        ...
                        <input class="form-control{{ $errors->has('email') ? ' is-invalid' : '' }}" name="email" id="input-email" type="email" placeholder="Email" value="{{ old('email') ?? $car->email }}" />
                        @if ($errors->has('email'))
                  ...
                  <div class="col-sm-4" id="national_id">
                    ...
                    <div class="col-sm-12">
                        ...
                        <input class="form-control{{ $errors->has('national_id') ? ' is-invalid' : '' }}" name="national_id" id="input-national_id" type="text" placeholder="{{ __('national_id') }}" value="{{ old('national_id') ?? $car->national_id }}" />
                  ...
                  <div class="col-sm-4" id="description">
                    ...
                    <div class="col-sm-12">
                        ...
                        <input class="form-control{{ $errors->has('kra_pin') ? ' is-invalid' : '' }}" name="kra_pin" id="input-kra_pin" type="text" placeholder="{{ __('kra_pin') }}" value="{{ old('kra_pin') ?? $car->kra_pin}}" />
                ...
                <div class="row w-100 p-3">
                  ...
                  <div class="col-sm-4">
                    ...
                    <div class="col-sm-12">
                        ...
                        <input class="form-control{{ $errors->has('purchase_date') ? ' is-invalid' : '' }}" name="purchase_date" id="input-purchase_date" type="text" placeholder="purchase_date" required="true" aria-required="true" value="{{ old('purchase_date') ?? $car->purchase_date }}" />
                  ...
                  <div class="col-sm-4" id="kra_pin">
                    ...
                    <div class="col-sm-12">
                        ...
                        <input class="form-control{{ $errors->has('description') ? ' is-invalid' : '' }}" name="description" id="input-description" type="text" placeholder="{{ __('description') }}" value="{{ old('description') ?? $car->description }}" required="true" aria-required="true"/>
            ...
            <button type="submit" class="btn btn-primary  btn-lg">{{ __('DONE') }}</button>
          </div>
